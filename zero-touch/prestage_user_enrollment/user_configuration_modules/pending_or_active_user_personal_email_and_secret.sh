...
#       Module Name: pending_or_active_user_personal_email_and_secret
#       Module Version: 1.0
#
...
#       The "Employee ID" field and the "Description" field for users must
...
while [ "$LOCATED_ACCOUNT" == "False" ]; do
    ...
    userSearch=$(
        curl -s \
            ...
            -H "x-api-key: ${APIKEY}" \
            -d '{"filter":[{"employeeIdentifier":"'${Secret}'","description":"'${PersonalEmail}'"}],"fields":["username"]}' \
