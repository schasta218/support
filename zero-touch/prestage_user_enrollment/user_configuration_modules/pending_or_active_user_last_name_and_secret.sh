...
#       Module Name: pending_or_active_user_last_name_and_secret
#       Module Version: 1.0
#
...
defaults write "$DEP_N_CONFIG_PLIST" textField1Placeholder "enter your last name"
...
LastName=$(defaults read $DEP_N_USER_INPUT_PLIST "Enter Your Last Name")
...
while [ "$LOCATED_ACCOUNT" == "False" ]; do
    ...
    userSearch=$(
        curl -s \
            ...
            -H "x-api-key: ${APIKEY}" \
            -d '{"filter":[{"employeeIdentifier":"'${Secret}'","lastname":"'${LastName}'"}],"fields":["username"]}' \
