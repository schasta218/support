...
)
{
    If (!(Check_Program_Installed("Microsoft Visual C\+\+ 2013 x64")))
    {
        ...
        DownloadLink -Link:($msvc2013x64Link) -Path:('C:\Windows\Temp\JCADMU\'+ $msvc2013x64File)
    ...
    If (!(Check_Program_Installed("Microsoft Visual C\+\+ 2013 x86")))
    {
        ...
        DownloadLink -Link:($msvc2013x86Link) -Path:('C:\Windows\Temp\JCADMU\'+ $msvc2013x86File)
